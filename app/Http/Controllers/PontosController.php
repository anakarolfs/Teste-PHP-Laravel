        ...
        public function buscarVencedoresLeilao()
    {
        ...
        $vencedores = DB::table('programa_pontos.vw_vencedor_leilao as v')
            ->select(
                ...
                //'v.dt_lance',
                DB::raw("to_char(dt_lance, 'DD/MM/YYYY HH24:MI') as dt_lance"),
                'v.st_lance',
                //'v.fim_leilao',
                DB::raw("to_char(fim_leilao, 'DD/MM/YYYY HH24:MI') as fim_leilao")
            )
            //->leftJoin('programa_pontos.vw_produtos as p', 'v.id_produto', '=', 'p.id_produto')
             ->leftJoin('programa_pontos.tb_produtos as p', 'v.id_produto', '=', 'p.id_produto')
