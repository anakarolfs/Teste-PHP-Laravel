  <div class="container">
      ...
      <div class="conteudo">
          <div id="input-pontos">
              ...
              <label class="label-gestao" for="matricula-alteracao input-grande">Colaborador(es)</label>
              ...
              <div class="modo">
                  <div class="opcao-modo" id="opcao-modo-creditar">
                      <input id="modo-creditar" class="input-modo" type="radio" name="modo-alteracao" value="1">
                      <label class="label-gestao branco" for="modo-creditar">Adicionar pontos</label>
                  </div>
                  <div id="tipo-bonificacao" class="tipo-container"></div>
                  <div class="opcao-modo" id="opcao-modo-debitar">
                      <input id="modo-debitar" class="input-modo" type="radio" name="modo-alteracao" value="0">
                      <label class="label-gestao branco" for="modo-debitar">Retirar pontos</label>
                  </div>
                  <div id="tipo-deducao" class="tipo-container"></div>
              </div>

              <label class="label-gestao" for="data-alteracao">Data</label>
              <input id="data-alteracao" name="data-alteracao" type="date" min="2024-03-11" max="2024-04-30">

              <label class="label-gestao" for="descricao-alteracao input-grande">Motivo</label>
  ...
  <script>
      $(document).ready(function() {
          ...
          $('input[name="modo-alteracao"]').on('change', liberaInputTipo);
          ...
          $.ajax({
              ...
              success: function(result) {
                  ...
                  arrayTipoDeducao.forEach(function(item) {
                      ...
                      $('input[name="modo-alteracao"]').on('change', desmarcaTipos);
                  });
              },
      ...
      // DESMARCA INPUT DE TIPO CASO INPUT DE MODO SEJA DESMARCADO
      function desmarcaTipos() {

          var valorModo = $('input[name="modo-alteracao"]:checked').val();

          if (valorModo === '1') {
              $('input[name="tipo-deducao"]').prop('checked', false);
          } else if (valorModo === '0') {
              $('input[name="tipo-bonificacao"]').prop('checked', false);
          }
      };
          ...
          if (modo == 0) { //debito
              ...
              $.ajax({
                  ...
                  success: function(result) {
                      ...
                      $('#matricula-alteracao').val('');
                      $('input[name="modo-alteracao"]').prop('checked', false);
                      $('#data-alteracao').val('');
                      $('#descricao-alteracao').val('');
                      if ($('input[name="tipo-bonificacao"]').length) {
                          $('input[name="tipo-bonificacao"]').prop('checked', false);
                      };
                      if ($('input[name="tipo-deducao"]').length) {
                          $('input[name="tipo-deducao"]').prop('checked', false);
                      };
