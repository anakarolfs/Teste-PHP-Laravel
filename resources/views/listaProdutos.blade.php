        ...
        <div class="produto">
            ...
            <div class="row" class="opcoes-produto">
                <div class="col-sm-12">
                    ...
                    @elseif($dtHoje == $produto->dt_fechamento && $hhHoje > $produto->hh_fechamento)
                        <button disabled type="button" class="btn btn-primary btn-comprar" style="width: 100%; border-color:#fc416f; background-color: #fc416f;">
                            Dar Lance
                        </button>
                    ...
                    @else
                        @if($produto->vr_lance != 0)
                            <div class="progress" style="height: 10px;" title="Progresso Moedas">
                                <div class="progress-bar progress-bar-striped bg-success" role="progressbar"
                                    style="height: 10px; width: {{ round(($minhasMoedas / $produto->vr_lance) * 100) }}%"
                                    aria-valuenow="25" aria-valuemin="0" aria-valuemax="{{ $produto->vr_lance }}">
                                </div>
                            </div>
                            <div style="margin-top: -16px; text-align: center; font-size: 12px;">
                                <img style="width: 12%; height: 22px;" src="assets\images\PLANCOIN.png" alt=""> {{ $minhasMoedas .' / '. $produto->vr_lance }}
                            </div>
                        @else
                            <div class="progress" style="height: 10px;" title="Progresso Moedas">
                                <div class="progress-bar progress-bar-striped bg-success" role="progressbar"
                    ...
                    <div class="col-sm-12" style="text-align: center; padding: 0;">
                        ...
                        @if(($dtHoje == $produto->dt_fechamento && $hhHoje > $produto->hh_fechamento) || $produto->ic_status == 3) 
