...
<!-- Modal LANCES -->
<div class="modal fade" id="modalLances" tabindex="-1" role="dialog" aria-labelledby="modalLancesLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h5 class="modal-title" id="modalLancesLabel">
                    <h4 id="divProduto"> </h4>
                </h5>
            ...
            <div class="modal-body">
                <form action="javascript:void(0);" id="formSalvarLance" class="form" method="POST"
                    ...
                    <div class="row" style="text-align: center;">
                        <div class="col-sm-12">
                            <h4> Ultimos Lances</h4>
                        </div>
                        <div class="col-sm-12">
                            <img style="height: 25px;" src="assets\images\PLANCOIN.png" alt="">
                            <span id="divUltLance"> </span>
                            <input type="hidden" id="InputUltLance" name="InputUltLance" />
                        </div>
                        <div class="col-sm-12">
                            <img style="height: 25px;" src="assets\images\PLANCOIN.png" alt="">
                            <span id="divUltLance2">  </span>
                        </div>
                        <div class="col-sm-12">
                            <img style="height: 25px;" src="assets\images\PLANCOIN.png" alt="">
                            <span id="divUltLance3"> </span>
                        </div> 
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <input required type="number" id="valorlanceProd" name="valorlanceProd" min="0"
                                max="{{ $minhasMoedas }}" size="50" maxlength="50" class="form-control"
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn modalSalvar" id="btnsalvarLance" onClick="salvarLance()">Enviar lance</button>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="modal-body">
                <form action="javascript:void(0);" id="formIniciarLeilao" class="form" method="POST"
                    ...
                    <div class="row" style="padding-top:10px">
                        ...
                        <div class=" col-md-6">
                            <label for="dataFimLeilao">Data fim leilão:</label>
                            <input type="date" class="form-control" id="dataFimLeilao" name="dataFimLeilao" required
                                value="<?= date('d/m/Y') ?>">
                        </div>
                        <div class=" col-md-6">
                            <label for="horaFimLeilao">Hora fim leilão:</label>
                            <input type="time" class="form-control" id="horaFimLeilao" name="horaFimLeilao" required
                                value="<?= date('23:59') ?>" />
                        </div>
                    </div>
            </div>
...
<script>
    ...
    function limitaDataFim() {
        ...
        limiteSuperior.setDate(limiteSuperior.getDate() + 20);

        var dataAtualFormatada = formataData(dataAtual);
        var limiteSuperiorFormatado = formataData(limiteSuperior);

        $('#dataFimLeilao').prop({
            'min': dataAtualFormatada,
            'max': limiteSuperiorFormatado
        });
    }
    ...
    window.onload = function() {
        document.getElementById('valorlanceProd').onkeypress = limite
    }
    ...
    function abirModalLance(idProd) {
        ...
        var div = document.getElementById("divUltLance2");
        div.innerHTML = "<span> </span>" + "\n";

        var div = document.getElementById("divUltLance3");
        div.innerHTML = "<span> </span>" + "\n";
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                /* FUNÇÃO RESPONSAVEL POR BUSCAR MATRICULA DO COOKIE * /
                let cookie = {};
                ...
                if(result.data[0].mat_lance == cookie['MATRICULA']){
                ...
                if (vr_produto == null || vr_produto == 0) {
                ...
                /*
                if(result.lance.length == 1){
                    alert('undefined');
                } */
                var nome0 = result.lance[0].nome.split(" ");
                var div = document.getElementById("divUltLance");
                div.innerHTML = "<span style='font-weight: bold;'>" + result.lance[0].vr_lance + " - " + nome0[0] + " - " + result.lance[0].mat_lance + " - " + result.lance[0].dt_lance + "</span>" + "\n";
                $('#InputUltLance').val(vr_produto);

                var nome1 = result.lance[1].nome.split(" ");
                var div = document.getElementById("divUltLance2");
                div.innerHTML = "<span>" + result.lance[1].vr_lance + " - " + nome1[0] + " - " + result.lance[1].mat_lance + " - " + result.lance[1].dt_lance + "</span>" + "\n";

                var nome2 = result.lance[2].nome.split(" ");
                var div = document.getElementById("divUltLance3");
                div.innerHTML = "<span>" + result.lance[2].vr_lance + " - " + nome2[0] + " - " + result.lance[2].mat_lance + " - " + result.lance[2].dt_lance + "</span>" + "\n";
    ...
    function salvarLance() {
        ...
        document.getElementById("btnsalvarLance").disabled = true;
        ...
        if (parseInt(valorLance) <= parseInt(UltLance)) {
    ...
    $(document).on("submit", "#formIniciarLeilao", function(event) {
        ...
        $.ajax({
            ...
            data: new FormData(
                this
            ), //$(this).serialize quer dizer que estou usando o formulario para serializar os campos em parametros do ajax
            cache: false,
            contentType: false,
            processData: false,
            url: 'IniciarLeilao',
