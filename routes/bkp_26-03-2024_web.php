...
Route::middleware(['accessPortal'])->group(function () {
    ...
    */
    ...
    // BUSCA DE INFORMAÃ‡Ã•ES DO OPERADOR NA CAMPANHA PARA PREENCHIMENTO DO CABEÃ‡ALHO NA MAIN
    ...
    // BUSCA NAS TB_TIPO(DEDUÃ‡ÃƒO E BONIFICAÃ‡ÃƒO)
